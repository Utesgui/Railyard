...
export const PASSAU_MAP: DrawnMap = {
  ...
  features: [
    ...
    // Sauwald: the forested granite plateau on the Austrian side between Danube and Pram valley
    { kind: 'zone', polygon: [[84, 52], [104, 56], [110, 64], [100, 74], [86, 72], [80, 62]], terrain: 'forest', density: 0.58, scale: 5 },
    { kind: 'zone', polygon: [[84, 52], [104, 56], [110, 64], [100, 74], [86, 72], [80, 62]], terrain: 'hills', density: 0.35, scale: 7 },
  ...
  towns: [
    ...
    // Upper Austria: the Innviertel east of the Inn and the Sauwald south of the Danube
    { name: 'Schärding', x: 68, y: 65, pop: 900, perks: SPA(10, 'Baroque old town (tourism)') },
    { name: 'Wernstein am Inn', x: 71, y: 57, pop: 300 },
    { name: 'Schardenberg', x: 73, y: 50, pop: 300 },
    { name: 'Suben', x: 64, y: 76, pop: 300 },
    { name: 'Taufkirchen an der Pram', x: 73, y: 78, pop: 400 },
    { name: 'Diersbach', x: 79, y: 71, pop: 300 },
    { name: 'Andorf', x: 82, y: 84, pop: 600 },
    { name: 'Enzenkirchen', x: 90, y: 80, pop: 300 },
    { name: 'Raab', x: 94, y: 88, pop: 300 },
    { name: 'Münzkirchen', x: 79, y: 63, pop: 350 },
    { name: 'St. Roman', x: 86, y: 61, pop: 300 },
    { name: 'Esternberg', x: 90, y: 53, pop: 350 },
    { name: 'Vichtenstein', x: 99, y: 56, pop: 300 },
    { name: 'Kopfing im Innkreis', x: 96, y: 69, pop: 300 },
    { name: 'St. Aegidi', x: 103, y: 67, pop: 300 },
    { name: 'Engelhartszell', x: 106, y: 58, pop: 300 },
    { name: 'Waldkirchen am Wesen', x: 114, y: 62, pop: 300 },
  ],
  industries: [
    ...
    { type: 'oilWell', x: 104, y: 77, name: 'Innviertel Oil Field' },
    { type: 'oilWell', x: 110, y: 86, name: 'Pramtal Oil Well' },
    // Austrian side: Innviertel farms, the Schärding brewery, Sauwald timber
    { type: 'farm', x: 86, y: 90, name: 'Pramtal Farm' },
    { type: 'farm', x: 70, y: 88, name: 'Innviertel Farm' },
